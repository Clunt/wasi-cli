...
<li>Imports:
<ul>
<li>interface <a href="#wasi_cli_environment_0_2_0"><code>wasi:cli/environment@0.2.0</code></a></li>
<li>interface <a href="#wasi_cli_exit_0_2_0"><code>wasi:cli/exit@0.2.0</code></a></li>
...
<li>interface <a href="#wasi_cli_terminal_input_0_2_0"><code>wasi:cli/terminal-input@0.2.0</code></a></li>
<li>interface <a href="#wasi_cli_terminal_output_0_2_0"><code>wasi:cli/terminal-output@0.2.0</code></a></li>
<li>interface <a href="#wasi_cli_terminal_stdin_0_2_0"><code>wasi:cli/terminal-stdin@0.2.0</code></a></li>
<li>interface <a href="#wasi_cli_terminal_stdout_0_2_0"><code>wasi:cli/terminal-stdout@0.2.0</code></a></li>
<li>interface <a href="#wasi_cli_terminal_stderr_0_2_0"><code>wasi:cli/terminal-stderr@0.2.0</code></a></li>
...
<li>Exports:
<ul>
<li>interface <a href="#wasi_cli_run_0_2_0"><code>wasi:cli/run@0.2.0</code></a></li>
</ul>
</li>
</ul>
<h2><a name="wasi_cli_environment_0_2_0"></a>Import interface wasi:cli/environment@0.2.0</h2>
<hr />
<h3>Functions</h3>
<h4><a name="get_environment"></a><code>get-environment: func</code></h4>
<p>获取POSIX风格的环境变量。</p>
<p>每个环境变量都以一对字符串变量名和字符串值的形式提供。</p>
<p>道义上讲，这些是值导入，但在组件模型中可用值导入之前，此导入函数每次调用时应返回相同的值。</p>
<h5>Return values</h5>
<ul>
<li><a name="get_environment.0"></a> list&lt;(<code>string</code>, <code>string</code>)&gt;</li>
</ul>
<h4><a name="get_arguments"></a><code>get-arguments: func</code></h4>
<p>获取程序的POSIX风格参数。</p>
<h5>Return values</h5>
<ul>
<li><a name="get_arguments.0"></a> list&lt;<code>string</code>&gt;</li>
</ul>
<h4><a name="initial_cwd"></a><code>initial-cwd: func</code></h4>
<p>返回程序应该用作其初始化当前工作目录的路径，<code>.</code>解释为此路径的简写。</p>
<h5>Return values</h5>
<ul>
<li><a name="initial_cwd.0"></a> option&lt;<code>string</code>&gt;</li>
</ul>
<h2><a name="wasi_cli_exit_0_2_0"></a>Import interface wasi:cli/exit@0.2.0</h2>
<hr />
<h3>Functions</h3>
<h4><a name="exit"></a><code>exit: func</code></h4>
<p>退出当前实例及所有关联实例。</p>
<h5>Params</h5>
<ul>
...
<h2><a name="wasi_cli_terminal_input_0_2_0"></a>Import interface wasi:cli/terminal-input@0.2.0</h2>
<p>终端输入。</p>
<p>未来，它可能包含用于禁用回显、禁用输入缓冲以便键盘事件立即发送、查询支持的功能等功能。</p>
<hr />
<h3>Types</h3>
<h4><a name="terminal_input"></a><code>resource terminal-input</code></h4>
<p>终端的输入端。</p>
<h2><a name="wasi_cli_terminal_output_0_2_0"></a>Import interface wasi:cli/terminal-output@0.2.0</h2>
<p>终端输出。</p>
<p>未来，它可能包含用于查询终端大小、接收终端大小变化通知、查询支持的功能等功能。</p>
<hr />
<h3>Types</h3>
<h4><a name="terminal_output"></a><code>resource terminal-output</code></h4>
<p>终端的输出端。</p>
<h2><a name="wasi_cli_terminal_stdin_0_2_0"></a>Import interface wasi:cli/terminal-stdin@0.2.0</h2>
<p>接口提供可选的<a href="#terminal_input"><code>terminal-input</code></a>作为链接时间授权（link-time authority）用于stdin。</p>
<hr />
<h3>Types</h3>
<h4><a name="terminal_input"></a><code>type terminal-input</code></h4>
<p><a href="#terminal_input"><a href="#terminal_input"><code>terminal-input</code></a></a></p>
<p>
----
<h3>Functions</h3>
<h4><a name="get_terminal_stdin"></a><code>get-terminal-stdin: func</code></h4>
<p>如果stdin连接到终端，则返回一个<a href="#terminal_input"><code>terminal-input</code></a>句柄，允许进一步与其交互。</p>
<h5>Return values</h5>
<ul>
<li><a name="get_terminal_stdin.0"></a> option&lt;own&lt;<a href="#terminal_input"><a href="#terminal_input"><code>terminal-input</code></a></a>&gt;&gt;</li>
</ul>
<h2><a name="wasi_cli_terminal_stdout_0_2_0"></a>Import interface wasi:cli/terminal-stdout@0.2.0</h2>
<p>接口提供可选的<a href="#terminal_output"><code>terminal-output</code></a>作为链接时间授权（link-time authority）用于stdout。</p>
<hr />
<h3>Types</h3>
<h4><a name="terminal_output"></a><code>type terminal-output</code></h4>
<p><a href="#terminal_output"><a href="#terminal_output"><code>terminal-output</code></a></a></p>
<p>
----
<h3>Functions</h3>
<h4><a name="get_terminal_stdout"></a><code>get-terminal-stdout: func</code></h4>
<p>如果stdout连接到终端，则返回一个<a href="#terminal_output"><code>terminal-output</code></a>句柄，允许进一步与其交互。</p>
<h5>Return values</h5>
<ul>
...
<h2><a name="wasi_cli_terminal_stderr_0_2_0"></a>Import interface wasi:cli/terminal-stderr@0.2.0</h2>
<p>接口提供可选的<a href="#terminal_output"><code>terminal-output</code></a>作为链接时间授权（link-time authority）用于stderr。</p>
<hr />
<h3>Types</h3>
<h4><a name="terminal_output"></a><code>type terminal-output</code></h4>
<p><a href="#terminal_output"><a href="#terminal_output"><code>terminal-output</code></a></a></p>
...
----
<h3>Functions</h3>
<h4><a name="get_terminal_stderr"></a><code>get-terminal-stderr: func</code></h4>
<p>如果stderr连接到终端，则返回一个<a href="#terminal_output"><code>terminal-output</code></a>句柄，允许进一步与其交互。</p>
<h5>Return values</h5>
<ul>
...
<h2><a name="wasi_cli_run_0_2_0"></a>Export interface wasi:cli/run@0.2.0</h2>
<hr />
<h3>Functions</h3>
<h4><a name="run"></a><code>run: func</code></h4>
<p>运行程序。</p>
<h5>Return values</h5>
<ul>
